...
fsm = FiniteStateMachine(
    ...
    state_parser=lambda code: {enum.value: enum.name for enum in AppState}[code],  # lambda function, that converts enum-value to enum-name visible in `fsm.state_string`. This is good default implementation
